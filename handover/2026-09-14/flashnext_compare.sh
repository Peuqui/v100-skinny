...
W=$HOME/.cache/mtp-diagnostics/fncmp_$NAME; rm -rf "$W"; mkdir -p "$W"
PORT=8027
...
FRAGEN = [("q1", "Erklaere die Quantenphysik in 30 Saetzen."), ("q2", "Erklaere den Regenbogeneffekt in 30 Saetzen.")] + [(f"q3{i}", "Erklaere den Kuanda-Effekt in 30 Saetzen.") for i in "abcd"]
def ask(user, mt):
