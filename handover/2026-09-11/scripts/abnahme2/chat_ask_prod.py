...
CTX = open(f"{SCR}/vorkontext.txt").read() * int(os.environ.get("CTX_REPEAT", "1"))
FRAGEN = [
...
def ask(user, mt):
    b = json.dumps({"model": "Qwen3.8-Flash-Next-180B-A4B-NVFP4-MTPQ-vllm", "max_tokens": mt, "temperature": 0, "seed": 1,
