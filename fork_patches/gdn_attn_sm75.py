...
def async_tensor_h2d(
    ...
    """Upstream-0.27.1 semantics of async_tensor_h2d (tensor/ndarray input,
    dtype optional); the fork's helper of the same name requires a
    positional dtype and only accepts lists."""
    import numpy as np
...
class GDNAttentionMetadataBuilder(AttentionMetadataBuilder[GDNAttentionMetadata]):
    ...
    def __init__(
        ...
        from vllm.model_executor.layers.mamba.gdn.qwen_gdn_linear_attn_sm75 import (
