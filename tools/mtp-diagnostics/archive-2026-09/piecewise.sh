...
set -uo pipefail
W=/tmp/claude-1000/-home-mp-Projekte-AIfred-Intelligence/e75152f1-399f-4af7-baec-5de4bb58bb22/scratchpad/piecewise
...
/home/mp/vllm/venv/bin/python -m vllm.entrypoints.openai.api_server \
  ...
  --compilation-config '{"cudagraph_mode":"PIECEWISE","cudagraph_capture_sizes":[1,2,4,8]}' > $W/boot.log 2>&1 &
S=$!
