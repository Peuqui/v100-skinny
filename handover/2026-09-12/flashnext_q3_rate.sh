...
W=$HOME/.cache/mtp-diagnostics/fnq3_$NAME; rm -rf "$W"; mkdir -p "$W"
PORT=8027
...
FRAGEN = [(f"q3{i}", "Erklaere den Kuanda-Effekt in 30 Saetzen.") for i in "abc"]   # Verschreiber ABSICHTLICH; dreimal fuer eine Rate
def ask(user, mt):
