...
set -uo pipefail
cd /tmp  # nie mit cwd im Checkout
A=/home/mp/Projekte/vllm-research/v100-skinny/handover/2026-09-12/prod_fa2c; B=$A/beleg_plefix; PY=/home/mp/vllm/venv/bin/python
...
FN=unused; Q=$A/Qwen3.8-27B-NVFP4-vllm.launch.sh
