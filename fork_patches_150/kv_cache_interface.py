...
class KVCacheSpec:
    ...
    def prefix_cacheable(self) -> bool:
        """Whether blocks of this spec take part in prefix-cache lookup.

        fork: default True preserves the behaviour from before the Qwen4Exp
        port, where no group was filtered out. Specs that must opt out (e.g.
        CircularBufferSpec) override this with False.
        """
        return True
