...
exec /home/mp/Projekte/v100-skinny/.venv-sm70-130/bin/python \
  ...
  --speculative-config '{"method": "dspark", "num_speculative_tokens": 5, "enforce_eager": true}' --compilation-config '{"cudagraph_capture_sizes":[6],"max_cudagraph_capture_size":6}' --host 127.0.0.1 --port 19998
