...
class KVBlockZeroer:
    ...
    def __init__(self, device: torch.device, pin_memory: bool):
        ...
        # One entry per distinct page size: (seg_addrs, page_size_el,
        # blk_size, n_segs). Hybrid caches (CSA+linear) mix page sizes, so the
        # kernel -- which takes the page size as a constexpr -- is launched
        # once per size.
    ...
    def init_meta(
        ...
        seg_addrs_by_page: defaultdict[int, list[int]] = defaultdict(list)
        ...
        for group in attn_groups_iter:
            ...
            for layer_name in group.layer_names:
                ...
                if isinstance(spec, FullAttentionSpec):
                    ...
                    seg_addrs_by_page[cur_page_el].append(dp)
