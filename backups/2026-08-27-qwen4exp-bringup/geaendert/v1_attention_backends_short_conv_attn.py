    ...
    def build(  # type: ignore[override]
        ...
        **kwargs: Any,
        ...
        if query_start_loc.device.type == "cpu":
            ...
            # This fork's async_tensor_h2d builds a tensor from a list and
            # needs an explicit dtype; the mask is already a CPU tensor, so
            # move it directly (same effect as the upstream helper's tensor
            # branch, cf. gdn_attn_sm75.async_tensor_h2d).
