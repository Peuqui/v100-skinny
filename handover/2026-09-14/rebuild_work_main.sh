...
env -u VLLM_FLASH_ATTN_SRC_DIR CPATH=$V/lib/python3.12/site-packages/nvidia/cuda_cccl/include CUDA_HOME=/home/mp/vllm/cuda TORCH_CUDA_ARCH_LIST=7.0 MAX_JOBS=3 $V/bin/python -m pip install -e . --no-build-isolation
echo "PIP-EXIT $?"; date
