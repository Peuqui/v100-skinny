...
export VLLM_SM70_MTP_DUMP_STEP_DIR=/tmp/claude-1000/-home-mp-Projekte-AIfred-Intelligence/4cf8936a-ff40-404e-b937-03cbf993c03b/scratchpad/draft-dumps
...
exec /home/mp/Projekte/v100-skinny/.venv-sm70-130/bin/python \
  ...
  --gpu-memory-utilization 0.97 --max-model-len 4096 \
  --max-num-seqs 1 --max-num-batched-tokens 256 --kv-cache-dtype fp8 --num-gpu-blocks-override 512 \
  --enforce-eager --speculative-config '{"method": "dspark", "num_speculative_tokens": 5}' --host 127.0.0.1 --port 19998
