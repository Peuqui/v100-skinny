...
def qsa_sparse_paged_attention(
    ...
    # bytes -- 80 KiB at BLOCK_N 64 and HEAD_DIM 256. Turing grants 64 KiB and
    # gfx942/gfx950 the same (Volta has 96 KiB), so narrow the tile to the
    # widest one the device can actually hold rather than asking the platform
    # for its name.
