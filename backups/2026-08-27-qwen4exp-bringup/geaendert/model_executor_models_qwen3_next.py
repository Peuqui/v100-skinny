...
class Qwen3NextAttention(nn.Module):
    ...
    def _project_qkv_gate(
        ...
        """Split the fused QKV projection into normed, rotated q/k, v and gate.

        The gate is returned unactivated -- callers apply the sigmoid where
        they combine it with the attention output. Shared with the Qwen4Exp
        QSA owner, which reuses this projection but its own attention core.
        """
