...
class AutoWeightsLoader:
    ...
    def _load_param(
        ...
        for weight_name, weight_data in weights:
            ...
            # WeightsMapper.apply tags weights that `orig_to_new_stacked` folded
            # into one packed parameter; their loaders take the shard as a third
            # argument. Without it the loader would treat a single shard as the
            # whole fused tensor.
