...
echo "=== Lauf 1 (SKINNY=0, MIT FIX, Cache leer)"; run_phase hit1 0 1
echo "=== Lauf 2 (SKINNY=0, MIT FIX, gleicher Cache)"; run_phase hit2 0 0
echo "FERTIG-HIT"
