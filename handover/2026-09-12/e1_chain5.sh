...
for P in "0,2 e1k_rtx_mtp mtp" "1,3 e1k_v100_mtp mtp" "0,2 e1k_rtx_0 0" "1,3 e1k_v100_0 0"; do
  set -- $P; wait_free; echo "== $2"
  env KV_DTYPE=auto ATTN_BACKEND=TRITON_ATTN VENV=$V DEVS=$1 VLLM_SM70_QUANT_BACKEND=auto bash tools/mtp-diagnostics/speed_dflash.sh $2 upstream $3 > $HOME/.cache/mtp-diagnostics/sweep_$2.log 2>&1; summ $2
done
echo E1-ENDE
